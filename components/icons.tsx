...
export const SearchIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5 mr-2" }) => (
...
export const InfoIcon: React.FC<{ className?: string }> = ({ className = "w-4 h-4" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><circle cx="12" cy="12" r="10"></circle><line x1="12" x2="12" y1="16" y2="12"></line><line x1="12" x2="12.01" y1="8" y2="8"></line></svg>
);

export const KeyIcon: React.FC<{ className?: string }> = ({ className = "w-4 h-4 text-blue-400" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><circle cx="7.5" cy="15.5" r="5.5"></circle><path d="m21 2-9.6 9.6"></path><path d="M15.5 7.5 18 5l-2.5-2.5"></path></svg>
);

export const DatabaseIcon: React.FC<{ className?: string }> = ({ className = "w-4 h-4 text-blue-400" }) => (
...
export const ZapIcon: React.FC<{ className?: string }> = ({ className = "w-4 h-4 text-blue-400" }) => (
...
export const RefreshCwIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5 mr-2" }) => (
...
export const CopyIcon: React.FC<{ className?: string }> = ({ className = "w-4 h-4 mr-2" }) => (
...
export const DownloadIcon: React.FC<{ className?: string }> = ({ className = "w-4 h-4 mr-2" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" x2="12" y1="15" y2="3"></line></svg>
);

export const FileTextIcon: React.FC<{ className?: string }> = ({ className = "w-4 h-4 mr-2" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" x2="8" y1="13" y2="13"></line><line x1="16" x2="8" y1="17" y2="17"></line><line x1="10" x2="8" y1="9" y2="9"></line></svg>
);

export const TableIcon: React.FC<{ className?: string }> = ({ className = "w-4 h-4 mr-2" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.37 3.63a2.12 2.12 0 1 1 3 3L12 16l-4 1 1-4Z"></path></svg>
);

export const HistoryIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5 text-gray-400" }) => (
...
export const AlertTriangleIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5 text-red-400" }) => (
