...
export const ShieldIcon: React.FC<{ className?: string }> = ({ className = "w-12 h-12 text-blue-400" }) => (
...
export const LoginKeyIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5 text-gray-400" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M21 2l-2 2m-7.61 7.61a5.5 5.5 0 1 1-7.778 7.778 5.5 5.5 0 0 1 7.777-7.777z"></path><path d="M12 15a3 3 0 1 0-4.24-4.24l.71.71"></path></svg>
);

export const LoginAuthIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5 mr-2" }) => (
...
export const AlertCircleIcon: React.FC<{ className?: string }> = ({ className = "w-4 h-4" }) => (
